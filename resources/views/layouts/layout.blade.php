...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Sender">
...
{{--    <link rel="stylesheet" href="{{asset('css\font-awesome.min.css')}}">--}}
    ...
    @if($page == 'orders')
        <link rel="stylesheet" href="{{ asset('css/mod_datatables.css') }}">
    @endif
...
{{--    <script defer="" src="https://static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"version":"2021.1.2","rayId":"61bd5fa86d66fa64","si":10}'></script>--}}
